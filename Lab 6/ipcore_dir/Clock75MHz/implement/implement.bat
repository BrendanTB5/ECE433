...
xst -ifn xst.scr
move Clock75MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock75MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock75MHz_exdes.ucf Clock75MHz_exdes

echo 'Running map'
map -timing -pr b Clock75MHz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock75MHz_exdes -w routed.ncd routed.v
cd ..
